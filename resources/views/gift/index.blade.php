                                                        ...
                                                        @foreach($inventario as $producto)
                                                            <tr class="bold producto-row">
                                                                ...
                                                                <td class="d-flex flex-row bd-highlight">
                                                                    <form id="comeBackGift" action="{{ route('inventario.comeBackGift', $producto->id) }}" method="POST">
                                                                        {{ csrf_field() }}
                                                                        {{ method_field('POST') }}
                                                                        <button class="btn btn-info btn-xs mr-2" onclick="comeBackGift()" type="button"><span class="fa fa-gift"></span></button>
                                                                    </form>

                                                                    @if(Auth::user()->isSuper())


                                                                    <a class="btn btn-primary btn-xs mr-2" href="{{ route('inventario.edit', $producto->id) }}" ><span class="fa fa-pencil"></span></a>
