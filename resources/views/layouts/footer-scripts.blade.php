...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        function fetchOverdueAlquileres() {
            fetch('/check-overdue-alquileres')
        ...
        function showAlerts(alquileres) {
            ...
            alquileres.forEach(alquiler => {
                ...
                alert.textContent = `El alquiler del producto ${alquiler.producto} (${alquiler.marca}) a nombre de ${alquiler.cliente} está vencido por ${alquiler.dias_vencidos} días. Costo adicional para extension: ${alquiler.costo_adicional.toFixed(2)}. ${alquiler.es_extension ? 'La extensión del alquiler ha vencido.' : ''}`;
