...
@section('page-header')
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title">Inventario venta</h4>
							</div>
						</div>
						<!--End Page header-->
@endsection
									...
									<div class="card-header">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="card-options d-flex flex-wrap  flex-column flex-sm-row">
                                                ...
                                                <form id="searchForm" action="{{ route('export.inventario.venta') }}" method="POST">
                                                    @csrf
                                                            ...
                                                            <tr class="bold producto-row">
                                                                ...
                                                                <td class="d-flex flex-row bd-highlight">
                                                                    ...
                                                                    @if(Auth::user()->isSuper())
                                                                        ...
                                                                        <form id="deleteForm" action="{{ route('inventario.destroy', $producto->id) }}" method="delete">
                                                                                {{ csrf_field() }}
                                                                                {{ method_field('DELETE') }}
