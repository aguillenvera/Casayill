								...
								<div class="card">
                                    ...
                                    <div class="mb-5">
                                        <form method="GET" action="{{ route('ingreso.index') }}">
                                            ...
                                            <a href="{{ route('ingreso.index') }}" class="btn btn-primary">Limpiar</a>
                                        </form>
                                    </div>
										...
										<div class="table-responsive">
                                            <table id="example" class="table table-bordered text-nowrap key-buttons">
                                                <thead>
                                                    ...
                                                    <th class="border-bottom-0">Fecha de ingreso</th>
                                                    ...
                                                    @if($ingresos->isNotEmpty())
                                                        @foreach($ingresos as $producto)
                                                            <tr class="bold producto-row">
                                                                <td>{{$producto->id}}</td>
                                                                <!-- <td>{{ ucfirst($producto->tipo_ingreso) }}</td>
                                                                <td>{{ $producto->monto }}</td> -->
                                                                <td>{{ Carbon\Carbon::parse($producto->fecha)->format('d/m/Y') }}</td>

                                                                @if(Auth::user()->isSuper())

                                                                <td><a class="btn btn-primary btn-xs" title="ver detalle del gasto" href="{{ route('ingreso.show', $producto->id) }}" >
                                                                        <span class="&#xF33E">
