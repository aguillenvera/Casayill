...
@section('page-header')
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title">Agregar Gastos Diarios</h4>
							</div>
							...
							<div class="col-xl-12 col-lg-12 col-md-12">
								<div class="card">
                                    <div class="card-header">
										<div class="card-title">Agregar un Gasto</div>
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('gasto.store') }}"  role="form">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" name="gasto" id="gasto" value="{{old('gasto')}}"  class="form-control input-sm" placeholder="gasto">
                                            </div>

                                            <div class="input-group mb-3">
                                                <span class="input-group-addon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="side-menu__icon"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></span>
                                                <input type="date" name="fecha" id="gasto" value="{{old('fecha')}}"  class="form-control input-sm" placeholder="fecha">
                                            </div>

                                            <div class="input-group mb-3">
                                                <span class="input-group-addon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="side-menu__icon"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></span>
                                                <input type="number" name="monto_gasto" id="monto_gasto" value="{{old('monto_gasto')}}"  class="form-control input-sm" placeholder="Monto del gasto">
                                            </div>
