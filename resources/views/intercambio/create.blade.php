...
@section('page-header')
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title">Agregar Intercambio</h4>
							</div>
							...
							<div class="col-xl-12 col-lg-12 col-md-12">
								<div class="card">
                                    <div class="card-header">
										<div class="card-title">Agregar un Intercambio</div>
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('intercambio.store') }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @foreach($productos as $producto)
                                                    <div>
                                                        ...
                                                        <label>{{ $producto->producto }} - {{ $producto->marca }} - {{ $producto->tipo }} - {{ $producto->precio }} $</label>
                                                        <input type="number" class="form-control" name="productos[{{ $producto->id }}][cantidad]" placeholder="Cantidad" min="1">
                                                    </div>
                                                @endforeach
                                            </div>
                                            ...
                                            <span class="input-group-addon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="side-menu__icon"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></span>
                                                <input type="text" name="producto_intercambiado" id="producto_intercambiado" value="{{old('producto_intercambiado')}}"  class="form-control input-sm" placeholder="Ingrese el producto por el cual realizara el intercambio">
                                            </div>

                                            <button type="submit" class="btn btn-primary">Registrar Intercambio</button>
