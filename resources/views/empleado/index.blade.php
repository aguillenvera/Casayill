									...
									<div class="card-header">
										...
										<div class="card-options">
                                            <div class="btn-group ml-5 mb-0">
                                                <form id="searchForm" action="{{ route('empleado.export') }}" method="POST">
                                                    @csrf
                                                    ...
                                                    @if($empleados->isNotEmpty())
                                                        @foreach($empleados as $producto)
                                                            <tr class="bold producto-row">
                                                                ...
                                                                <td>
                                                                    <form id="deleteForm" action="{{ route('empleado.destroy', $producto) }}" method="POST">
                                                                    @csrf
                                                                        @method('DELETE')
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content modal-content-demo">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="{{ route('empleado.import') }}" role="form" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-xs-6">
