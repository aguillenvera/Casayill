    ...
    <body>
        ...
        <table class="table mt-5">
            <tbody>
                <tr>
                    <td class="border-0 pl-0">
                    @if ($invoice->getCustomData())
                        <p><strong>Fecha de Alquiler:</strong> {{ $invoice->getCustomData()['fecha_alquiler'] }}</p>
                        <p><strong>Fecha de Devolución:</strong> {{ $invoice->getCustomData()['fecha_devolucion'] }}</p>
                        <p><strong>Total en COP:</strong> {{ $invoice->getCustomData()['total_pesos'] }}</p>
                        <p><strong>Total en Bs:</strong> {{ $invoice->getCustomData()['total_bolivares'] }}</p>
                    @endif
                    </td>
                </tr>
            </tbody>
