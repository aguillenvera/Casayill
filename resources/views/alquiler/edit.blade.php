...
@section('page-header')
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title">Editar Alquiler</h4>
							</div>
...
@section('content')
							...
							<div class="col-xl-12 col-lg-12 col-md-12">
								<div class="card">
                                    <div class="card-header">
										<div class="card-title">Editar un Alquiler</div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="fecha_alquiler" value="{{ $alquiler->fecha_alquiler }}" class="form-control" required>
                    </div>

                    <!-- Cantidad -->
                    <div class="form-group">
                        <label for="cantidad">Cantidad</label>
                        <input type="number" name="cantidad" value="{{ $alquiler->cantidad }}" class="form-control" min="1" required>
                    </div>

                    <!-- Precio -->
                    <div class="form-group">
                        <label for="precio">Precio del producto (USD)</label>
                        <input type="text" name="precio" id="precio" value="{{ $alquiler->precio }}" class="form-control" required>
                    </div>
                    ...
                    <a class="btn btn-danger ml-5" href="{{route('alquiler.index')}}">Cancelar</a>
