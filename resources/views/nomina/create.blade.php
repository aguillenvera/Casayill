...
@section('page-header')
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title">Agregar Nomina de pago</h4>
							</div>
							...
							<div class="col-xl-12 col-lg-12 col-md-12">
								<div class="card">
                                    <div class="card-header">
										<div class="card-title">Registrar una Nomina</div>
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('nomina.store') }}"  role="form">
                                            @csrf
                                            <!-- Employed Selection or Creation -->
                                            <div class="input-group mb-3">
                                                ...
                                                <select name="empleado_id" id="empleado_id" class="form-control"  onchange="updateSalary()">
                                                    ...
                                                    @foreach($empleados as $empleado)
                                                        <option value="{{ $empleado->id }}" data-salary="{{ $empleado->salario }}">{{ $empleado->nombre }} {{ $empleado->apellido }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="input-group mb-3">
                                                <span class="input-group-addon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="side-menu__icon"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></span>
                                                <input type="number" name="monto" id="monto" value="{{old('monto')}}"  class="form-control input-sm" placeholder="monto" readonly>
                                            </div>
                                           
                                            <div class="input-group mb-3">
                                                <span class="input-group-addon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="side-menu__icon"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></span>
                                                <input type="date" name="fecha_pago" id="fecha_pago"value="{{old('fecha_pago')}}"  class="form-control input-sm" placeholder="Fecha de pago">
                                            </div>
                                            <div class="input-group mb-3">
                                                <span class="input-group-addon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="side-menu__icon"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></span>
                                                <input type="text" name="periodo" id="periodo" value="{{old('periodo')}}" class="form-control input-sm" placeholder="periodo">
                                            </div>
                                            

                                            <div class="col-xs-12">
                                                <button type="submit" class="btn btn-lg btn-primary">Crear</button>
                                                <a href="{{ route('nomina.index') }}" class="btn btn-lg btn-danger">Cancelar</a>
                                            </div>
                                        </form>
                                    </div>
								</div>
